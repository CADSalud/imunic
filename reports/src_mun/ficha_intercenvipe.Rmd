...
# municipios_selec_vec <- c("Álvaro Obregón", 9)
# municipios_selec_vec <- c("Cuajimalpa de Morelos", 9)
# municipios_selec_vec <- c("Sultepec", 15)
# municipios_selec_vec <- c("Texcaltitlán", 15)
# municipios_selec_vec <- c("Jilotepec", 30)
# municipios_selec_vec <- c("Chumatlán", 30)
# municipios_selec_vec <- c("San José del Rincón", 15)
